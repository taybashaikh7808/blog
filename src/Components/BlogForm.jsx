  ...
  return (
    <div className="bg-white p-6 rounded-lg w-[30rem] mx-auto">
      ...
      <div className="space-y-4">
        <input
          className="w-full h-[40px] p-2 font-semibold border-2"
          type="text"
          placeholder="Title"
          value={title}
        ...
        />
        <textarea
          className="w-full h-[80px] p-2 font-semibold border-2"
      ...
      <section className="flex justify-between mt-4">
        <button
          className="border-2 h-10 w-[75px] border-black font-bold bg-gray-300 hover:bg-gray-600 cursor-pointer"
          onClick={handleSubmit}
        >
          {existingBlog ? "Update" : "Add"}
        </button>
        <button
          className="border-2 h-10 w-[75px] border-black font-bold bg-gray-300 hover:bg-red-600 cursor-pointer"
          onClick={onClose}
        >
          Cancel
        </button>
